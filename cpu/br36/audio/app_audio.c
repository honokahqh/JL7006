...
#define USER_AUDIO_GAIN (0.42)
const u16 hw_dig_vol_table[DVOL_HW_LEVEL_MAX + 1] = {
    0    * USER_AUDIO_GAIN, //0
    323  * USER_AUDIO_GAIN, //1
    379  * USER_AUDIO_GAIN, //2
    445  * USER_AUDIO_GAIN, //3
    521  * USER_AUDIO_GAIN, //4
    610  * USER_AUDIO_GAIN, //5
    714  * USER_AUDIO_GAIN, //6
    835  * USER_AUDIO_GAIN, //7
    976  * USER_AUDIO_GAIN, //8
    1141 * USER_AUDIO_GAIN, //9
    1334 * USER_AUDIO_GAIN, //10
    1558 * USER_AUDIO_GAIN, //11
    1819 * USER_AUDIO_GAIN, //12
    2119 * USER_AUDIO_GAIN, //13
    2466 * USER_AUDIO_GAIN, //14
    2865 * USER_AUDIO_GAIN, //15
    3324 * USER_AUDIO_GAIN, //16
    3849 * USER_AUDIO_GAIN, //17
    4451 * USER_AUDIO_GAIN, //18
    5139 * USER_AUDIO_GAIN, //19
    5924 * USER_AUDIO_GAIN, //20
    6819 * USER_AUDIO_GAIN, //21
    7839 * USER_AUDIO_GAIN, //22
    8899 * USER_AUDIO_GAIN, //23
    10000* USER_AUDIO_GAIN, //24
    11000* USER_AUDIO_GAIN, //25
    12000* USER_AUDIO_GAIN, //26
    13000* USER_AUDIO_GAIN, //27
    14000* USER_AUDIO_GAIN, //28
    15000* USER_AUDIO_GAIN, //29
